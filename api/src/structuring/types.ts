...
{"vendorName","vendorAddress","vendorTaxId","invoiceNumber","poNumber","invoiceDate","dueDate","currency","subtotal","discountAmount","cgstAmount","sgstAmount","igstAmount","taxAmount","totalAmount","netAmount","paymentTerms","confidence","lineItems":[{"description","sku","hsnSac","quantity","unitPrice","amount","labourAmount","taxRate"}]}
