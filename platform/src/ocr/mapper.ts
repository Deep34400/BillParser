...
export function mapParsedToBill(
  ...
  return {
    ...
    extraction_pages: opts.costInfo?.extraction_pages ?? null,
...
export function billToInvoice(bill: BillDoc, parts?: BillPartDoc[]): FrontendInvoice {
  ...
  return {
    ...
    editedAt: null,
    activeRunId: null,
    batchId: bill.batch_id ?? null,
    batch: bill.batch_id ? { id: bill.batch_id, name: '' } : null,
    ...
    extractionPages: bill.extraction_pages ?? null,
